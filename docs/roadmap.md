...
| **Implementar o ADR 0012**: empacotar RetroArch + cores no instalador | G | [ADR 0012](decisoes/0012-empacotar-retroarch-e-cores.md) — decisão fechada, nada implementado ainda. Falta: checar licença de cada core, decidir o mecanismo de empacotamento no Tauri, medir o tamanho do instalador, escrever o aviso de licença (GPL) |
